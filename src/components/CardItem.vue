<template>
  <van-cell-group class="item">
    ...
    <!-- 通过动态 class 的形式，判断是支出还是收入，分别给不同的类名 -->
    <van-cell
...
/**
 * 样式分析
 * 因为想要修改 vant 内部样式的话，不能在带有 scoped 属性的 style 标签内修改，
 * 所以要“另起炉灶”，加一个不带 scoped 的 style 标签
 * 之所以要这样做，是因为带上 scoped 属性的 style 标签内的样式，编译后会被加上一串 hash 值，
 */ 
</style>