<template>
  <div class="data">
    <div class="total">
      ...
      <div v-if="payType=='expense'" class="box">
        <div class="title_expense">共支出</div>
        <div class="money_expense">¥{{ total_expense || 0 }}</div>
        <div class="income" @click="changeData('income')">共收入¥{{ total_income || 0 }}</div>
      </div>
      <div v-if="payType=='income'" class="box">
        <div class="title_income">共收入</div>
        <div class="money_income">¥{{ total_income || 0 }}</div>
        <div class="income" @click="changeData('expense')">共支出¥{{ total_expense || 0 }}</div>
      </div>
    </div>
    <div class="structure">
      <div class="head">
...
import PopMonth from '../components/PopMonth.vue' // 月份弹窗组件
